...
export default function Signupform() {
  ...
  return (
    <>
      <div className=" flex bg-blue-50 justify-center items-center h-full ">
        <div className=" min-w-1/2 px-3 min-h-100  mx-auto rounded-3xl shadow-2xl">
          <div className='p-5'>
            <h1 className='text-2xl font-bold'>Create account</h1>
            <p className='py-2'>Already have an account? <Link className='text-blue-500' to="/login">Login</Link></p>
          ...
          <form onSubmit={formik.handleSubmit} className="max-w-sm mx-auto pb-2 px-4 " >
            ...
            <div className="grid lg:grid-cols-2 sm:grid-cols-1 py-4">
